...
/-!
# Publication audit: theorem interfaces

**EN.** This module is the consolidated publication-facing trust-base audit. It checks public signatures (`#check`) and
...
aggregate. The consolidated audit includes four additional groups:
...
**FR.** Ce module destiné à la publication constitue l'audit consolidé de la base de confiance. Il vérifie les
...
conditionnelle stable. L'audit consolidé comprend quatre groupes supplémentaires :
...
-- ── Public-contract visibility: L0/L2/L3 witnesses ────────────────
...
-- ── Trust-base audit: L0/L2/L3 witnesses ──────────────────────────
